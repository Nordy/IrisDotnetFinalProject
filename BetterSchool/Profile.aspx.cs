    ...
    public partial class Profile : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (Request.Form["Submit"] != null)
            {
                ...
                string sql = $"INSERT INTO Tusers(username, password, fname, lname, class, mashovId, mashovPassword) VALUES(N'{username}', N'{password}', N'{fname}', N'{lname}', N'{grade}', '{mashovId}', N'{mashovPassword}')";
